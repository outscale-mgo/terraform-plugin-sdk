...
or submitting a patch.
 ...
 - `hashicorp/terraform` - Terraform **Core** which implements all the low-level functionality which isn't domain specific (that's covered by providers). Read more about [distinction between core & providers in the Readme](https://github.com/outscale-mgo/terraform-plugin-sdk/blob/master/README.md#scope-providers-vs-core).
